...
DBApp.controller('partyRoleImageManageCtrl', ['$scope', '$modal', 'dbUtils', PartyRoleImageManageCtrl]);

function PartyRoleImageManageCtrl($scope, $modal, dbUtils) {
    ...
    function viewPartyRoleDetail(source) {
        ...
        dbUtils.post("partyRoleImageGet", {id: source['id'], partyId: source['partyId'], businessType: source['businessType']}, function (data) {
            var instance = $modal.open({
                ...
                resolve: {
                    source: function () {
                        data["infoUrl"] = "partyRoleImageInfo";
                        return data;
                    }
                }
            });
