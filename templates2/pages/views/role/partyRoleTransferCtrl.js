...
DBApp.controller("partyRoleTransferCtrl", ['$scope', '$modal', 'dbUtils', PartyRoleTransferCtrl]);

function PartyRoleTransferCtrl($scope, $modal, dbUtils) {
    ...
    var formGridOptions = {
        ...
        grid: {
            settings: {
                transCode: "partyRoleTransferPage",
                autoLoad: true,
                page: {pageSize: 10},
                showCheckBox: false
            },
    ...
    var formGridEvents = {
        grid: {
            ...
            rowEvents: [
                {
                    "name": "调动", "class": "btn-warning", "click": function (row) {
                    console.log(row);
    ...
    function viewPartyRoleDetail(source) {
        ...
        dbUtils.post("partyRoleTransferGet", {id: source['id'], partyId: source['partyId'], businessType: source['businessType']}, function (data) {
            var instance = $modal.open({
                ...
                resolve: {
                    source: function () {
                        data["infoUrl"] = "partyRoleTransferInfo";
                        return data;
                    }
                }
            });
