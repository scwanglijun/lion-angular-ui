...
DBApp.controller("productSearchCtrl", ['$scope', '$modal', 'dbUtils', ProductSearchCtrl]);

function ProductSearchCtrl($scope, $modal, dbUtils) {
    ...
    function viewDetail(source) {
        dbUtils.post("productSearchGet", {id: source['id']}, function (data) {
            $modal.open({
                animation: true,
