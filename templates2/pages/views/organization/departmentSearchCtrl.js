...
DBApp.controller("departmentSearchCtrl", ['$scope', '$window','dbImService','dbUtils','$timeout', DepartmentSearchCtrl]);

function DepartmentSearchCtrl($scope,$window,dbImService,dbUtils,$timeout) {
    //设置不使用缓存和查询范围
